...
public class LoginPage {
	...
	private WebElement warningMsgforLogin;
	...
	public String getWarningMessageText() {
		...
		return elementUtils.getTextFromElement(warningMsgforLogin, CommonUtils.EXPLICIT_WAIT_BASIC_TIME);
		//return warningMsgforLogin.getText();
	}
}
